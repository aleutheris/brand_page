...
- FR-001 | Publish clear hero and services narrative | Priority: High | Item: `backlog-items/FR-001.md`
- FR-002 | Publish schema-backed project listing | Priority: High | Item: `backlog-items/FR-002.md`
- FR-003 | Deliver reliable contact conversion path | Priority: High | Item: `backlog-items/FR-003.md`
